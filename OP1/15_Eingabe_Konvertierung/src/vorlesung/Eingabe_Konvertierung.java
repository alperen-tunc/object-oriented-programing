...
public class Eingabe_Konvertierung
{
    public static void main(String[] args)
    {
        ...
        Scanner scanner = new Scanner(System.in); // Hier erstellen wir ein Objekt genannt "scanner" der Scanner-Klasse und übergeben dem Konstruktor den Wert "System.in".
        ...
        System.out.println("Ihr Eingabe lautet: " + text);
        ...
        int zahl = Integer.parseInt(zahlAlsString); // Umwandlung mit parseInt() in einen Integer.
        ...
        try
        {
            ...
            System.out.println("Geben Sie eine Zahl ein (nextInt): ");
        ...
        while (!eingabeOk) // Solange die Eingabe NICHT OK ist... (dafür das ! vor eingabeOk)
        {
            try
            {
                ...
                System.out.println(eingabe);
                eingabeOk = true; // War die Eingabe korrekt, setzen wir eingabeOk auf true und verlassen damit die Schleife.
            }
     ...
     */
    public static int eingabeInteger() throws NumberFormatException // Um deutlich zu machen, dass diese Methode eine Exception verursachen könnte, fügen wir ihr in der Deklaration die Exception hinzu. Bei den sogenannten "Checked Exceptions" ist dies Pflicht, bei "Unchecked Exceptions" ist es freiwillig.
    {
     ...
     * @return Der konvertierte Integer.
     */
    public static int eingabeIntegerMitTryCatch()
    {
        ...
        while (true)
        {
            ...
            catch (NumberFormatException ex) // Die Exception fangen wir hier ab und geben eine Fehlermeldung aus.
            {
