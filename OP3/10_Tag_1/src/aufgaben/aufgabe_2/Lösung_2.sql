...
(1111, 'Lisa', 'Müller', CONVERT(DATE, '15.04.1990', 104), 237)
-- In Visual Studio sollten Datum-Angaben im Format Monat-Tag-Jahr angegeben werden, oder Jahr-Monat-Tag. Möchte man etwas anderes, kann konvertiert werden:
